...
class dbOperations {
	...
	private $dbname;
	private $inputArray;
	private $params = "DEFAULT CHARACTER SET=utf8 COLLATE=utf8_bin ENGINE=InnoDB;";
	private $salt;
	private $pid;
	private $fid;
	...
	function __construct($dbConfig,$inputArray,$relpath=FALSE,$tableName="tx_myForm_",$suffix="001",$salt="I|1Tofu+-Wev>w.W=S\$Y+5$44HC;[<",$pid=FALSE,$fid=FALSE) {
